...
Calendar settings live in **Settings → Operations → Calendar**. They control default behaviors and display preferences across the entire calendar system.

The page has three tabs:

| Tab | Contents |
|-----|----------|
| **General Settings** | Work hours, default meeting duration, week start day, and display preferences |
| **Freeze Windows** | Periods when changes are frozen, scoped to the tenant, a company, or a site |
| **Post-Meeting** | The post-meeting wrap-up flow, the internal survey questions, and QBR log automation |

<Note>
Calendar settings moved out of the Calendar menu. The old **Calendar → Settings** link now redirects here, and the Calendar page keeps a **Settings** shortcut in its overflow menu. Access needs the Calendar Settings permission, which existing calendar managers already have.
</Note>
...
- **[Calendar Guide](/user-guides/calendar/index)** - Full calendar documentation
- **[Microsoft 365](/user-guides/microsoft-365/index)** - Configure calendar synchronization
- **[User Management](/user-guides/settings/users-roles)** - Manage calendar permissions

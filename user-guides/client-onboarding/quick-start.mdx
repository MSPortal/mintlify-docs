...
<Steps>
  ...
  <Step title="Check the client experience">
    The portal opens in a new tab exactly as that person will see it — branding, visible tasks, pages, and documents. Anything hidden from clients stays hidden.
  </Step>
</Steps>

<Tip>
**View as** works on a Draft portal, so this is the way to test a template end to end without going live or emailing anyone. Build the template, create a Draft portal on a test company, and preview it. Nothing sends until you click **Start Portal**.
</Tip>

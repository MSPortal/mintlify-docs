...
The AI designer is a sidebar inside the template builder. It's always available and reads whatever template you have open, so there's nothing to enable, connect, or link a template to. Open a template, click **AI**, and start describing what you want.

<Steps>
  <Step title="Open the AI Sidebar">
    In the template builder, click the **AI** button on the right side of the screen to open the AI design sidebar.
  </Step>
...
<Steps>
  <Step title="Create a Draft portal">
    Pick a test or internal company, open its **Onboarding** tab, click **Start Onboarding**, and choose your template. The portal is created in **Draft** — nothing is sent to anyone.
  </Step>

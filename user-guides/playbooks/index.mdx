...
<Steps>
  <Step title="Navigate to Playbooks">
    Go to **Settings > Compliance** and open the **Playbooks** tab. From the Playbooks home, choose **Best Practices** or **Security Frameworks** (CIS Benchmarks live under Frameworks).
  </Step>
...
For applying multiple playbooks or managing playbooks at scale, use **Settings > Compliance > Playbooks**:

1. Navigate to **Settings > Compliance** and open the **Playbooks** tab

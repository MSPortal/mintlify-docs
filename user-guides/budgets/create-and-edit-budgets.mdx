...
Open an editable budget from the list. Expand **Budget Details** for header fields, or use a line's pencil menu and **Edit** for its costs. Make changes, choose **Save**, wait for confirmation, and reopen the budget from the list to verify the result. The edit page normally remains open after saving.
...
| Reopened budget shows an old price after Save | Confirm Save finished successfully, then reopen the budget from the list. If values still differ, reload before making further edits and ask your MSP to investigate. |

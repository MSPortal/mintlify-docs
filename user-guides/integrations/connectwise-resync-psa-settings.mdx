...
- Changed ticket types or subtypes
...
- **Types and Subtypes:** Ticket types and subtypes per board
- **Project Statuses:** Available project status options
- **Activity Types:** Sales activity types (used by CSAT follow-ups)
...
- A "sync started" confirmation appears
- The process runs automatically in the background
- Typical completion time: 1-2 minutes
- Refresh the page to see updated options once the sync finishes
...
- [Clear and Resync Tickets](./clear-and-resync-integrations)
...
<Warning>
Manual syncs are rate-limited. If you've just triggered a sync, you may need to wait a few minutes before triggering another.
</Warning>
...
Changes appear in MSPortal after the next scheduled sync for that data type. For frequently-synced data like tickets, that's typically within a few minutes; for daily reference data, it may take until the next day. If you need it sooner, use **Sync Now** on the integration card.

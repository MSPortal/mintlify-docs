...
<Steps>
  <Step title="Navigate to API Keys">
    Log into your Datto RMM portal and go to **Settings** &gt; **API** &gt; **API Keys**.
  </Step>

  <Step title="Generate API Key">
    Generate a new API key for MSPortal.
...
| Software | Datto → MSPortal | Installed software inventory for devices (synced every 30 minutes) |
...
<AccordionGroup>
  <Accordion title="Connection test fails">
    ...
    **Solutions:**
    ...
    3. Generate new API credentials under **Settings** &gt; **API** &gt; **API Keys** if needed
    4. Ensure your Datto RMM account has API access enabled
  </Accordion>

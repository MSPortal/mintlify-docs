...
When you select **Filtered projects**, three filters appear. A project is shown when it matches **at least one** selected type, board, or specific project.

| Filter | What it includes |
|--------|------------------|
| **Project types** | Every project with a selected PSA project type |
| **Project boards** | Projects with phases or tickets on a selected board |
| **Specific projects** | Hand-picked projects, chosen with a searchable selector |
...
<Steps>
  ...
  <Step title="Choose Your Filters">
    Select PSA project types, project boards, or search for specific projects. You can combine any of the three filters.
  </Step>
  <Step title="Save">

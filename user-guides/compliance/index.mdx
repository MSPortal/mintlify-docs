...
The compliance module offers two viewing options to suit your workflow. When risk tracking is enabled, a third **Risks** tab shows your risk register; see [Risk Management](/user-guides/compliance/risk-management).
...
Type `@` in a compliance note to mention a member of your staff. They receive a notification with a preview of the note that opens the exact compliance item, so a question in a note reaches the person who can answer it without a separate message.

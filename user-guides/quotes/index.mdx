---
title: 'Quotes'
description: 'View Quoter, QuoteWerks, and Salesbuildr quotes directly inside MSPortal.ai'
icon: 'file-invoice-dollar'
---

The Quotes module brings your quotes from [Quoter](https://www.quoter.com), QuoteWerks, and Salesbuildr into MSPortal.ai, giving you a centralized view of all proposals alongside your other client data. Quotes sync automatically every 4 hours, so your team always has up-to-date pricing and proposal information without switching between tools. This guide uses Quoter for its examples; the QuoteWerks and Salesbuildr guides linked below cover their setup.
...
For quotes that come from Salesbuildr, the quote detail page shows a **Download PDF** button, and the actions menu on the Quotes list includes **Download PDF**. MSPortal fetches the PDF from Salesbuildr on demand, so it always reflects the current version of the quote. Client portal users can download PDFs for the quotes they can see.
...
- [Configure QuoteWerks Integration](/user-guides/integrations/enable-quotewerks-integration) - Sync QuoteWerks quotes into the Quotes module
- [Configure Salesbuildr Integration](/user-guides/integrations/enable-salesbuildr-integration) - Sync Salesbuildr quotes, PDFs, and products

...
<Info>
  Looking for license counts or assignments? Open **Cloud > Licenses** and use [Read cloud license usage](/user-guides/cloud/licenses). The former `/licensing` inventory route now opens Cloud Licenses; it supports Microsoft 365, Google Workspace, and Adobe according to your connections and access. The Pax8 settings described below are separate from that inventory.
</Info>

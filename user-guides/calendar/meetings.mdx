...
<Note>
A meeting with **Draft** status is visible to your team but hasn't sent invitations yet. Open the meeting and click **Save & Send** when you're ready to invite attendees. See [Draft Meetings](/user-guides/calendar/index#draft-meetings).
</Note>

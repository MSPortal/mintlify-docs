...
For a focused first template, follow [Create and preview a ticket template](/user-guides/ticketing/create-and-preview-ticket-template). It covers inactive drafts, Home AI Description, Preview, Save Template, and cancellation. The sections below cover additional configuration.

**Audience:** MSP staff. Company users should use [Understand your available request templates](/user-guides/ticketing/understand-request-templates).

## Prerequisites

- You need **write_settings_tickets** or **manage_settings_tickets** permission
...
<Steps>
  <Step title="Navigate to Templates">
    Go to **Settings > Tickets > Templates**.
  </Step>
  ...
  <Step title="Configure Template Details">
    ...
    - **Active Status**: New templates start active. Turn this off while drafting, then save the inactive state.
  </Step>
</Steps>
...
3. Click **Save Template** and wait for the result; success returns to Templates
4. When ready, reopen the template, enable the active switch, and click **Save Template** again
5. Verify availability for the intended Company and role. Preview alone does not prove access or submit a ticket
